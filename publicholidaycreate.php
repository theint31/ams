...
//         $name = $_POST['name'];
//     }else{
//         $name_err = "Please fill your name";
//         $err_status=true;
//     }
    ...
    // if($err_status==false){
    //     $publicholidayinsert = $publicholidaycontroller->insertPublicholidays($date,$day,$name);
    //     header('location:publicholiday_index.php');
    // }
// }
...
<div id="app">
    ...
    ?>
        ...
        <header class="mb-3">
            ...
            <h1>Public Holiday Create Form</h1>
            <form method="post">
                <div class="row">
                    <div class="col-md-4 ">
                        <div>

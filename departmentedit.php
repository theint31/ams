...
<div id="app">
    ...
    ?>
        ...
        <header class="mb-3">
            ...
            <h1>Department Edit Form</h1>
            <form method="post">
                <div class="row">
                    <div class="col-md-4 ">
                        <div>
                            <label>Department Name:</label>
                            <input type="text" name="name" id="name" class="form-control" value="<?php echo $result[1] ?>" />
                    ...
                    <div class="col-md-4">
                        <div>
                            ...
                            <input type="text" name="phone" id="phone" class="form-control" value="<?php echo $result[2] ?>"/>
                    ...
                    <div class="col-md-4">
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="form-control" value="<?php echo $result[3] ?>"/>
